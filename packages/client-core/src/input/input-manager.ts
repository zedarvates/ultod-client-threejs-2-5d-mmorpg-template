...
export class InputManager {
  ...
  private readonly joystick = new TouchJoystick(
    typeof document !== 'undefined' ? (document.getElementById('joystick-zone') as HTMLElement) : null,
    typeof document !== 'undefined' ? (document.getElementById('joystick-knob') as HTMLElement) : null,
  );
